...
def main():
    ...
    my_parser.add_argument('--data_path', type=str, default='/home/kannika/codes_AI/CSV/mini-ImageNet_MachineUnlearn.csv', help='Path to CSV file.')
    ...
    ## Create Models Name 
    modelName = f'model{args.network_name}_Unlearning_miniImageNet-{_R}.h5'
    on_epochName = f'model{args.network_name}_Unlearning_miniImageNet-{_R}'
    ## Create Model Folder 
