...
from vit_model import loadresumemodel, build_vit_unlearn
...
def main():
    ...
    my_parser.add_argument('--gpu', type=int, default=1, help='Number GPU 0,1 [device: 1, name: NVIDIA GeForce RTX 3090 Ti]')
    my_parser.add_argument('--set', type=str, default='ViT_unlearn', help='[ViT_unlearn, ViTunlearn_USAI]')
    my_parser.add_argument('--data_path', type=str, default='/home/kannika/codes_AI/CSV/mini-ImageNet_MachineUnlearn.csv', help='Path to CSV >> [miniImageNet: /home/kannika/codes_AI/CSV/mini-ImageNet_MachineUnlearn.csv], [USAI: /home/kannika/codes_AI/CSV]')
    my_parser.add_argument('--data', type=str, default=".", help='For train with USAI15ab dataset [balanced, unbalanced]')
    my_parser.add_argument('--save_dir', type=str, default="/media/HDD/mini-ImageNet/ViTModel_unlearn", help='Main Output Path >> [ViT_unlearn: /media/HDD/mini-ImageNet/ViTModel_unlearn], [ViTunlearn_USAI: /media/HDD/mini-ImageNet/ViTModel_USAI]')
    ...
    my_parser.add_argument('--lr', type=float, default=1e-5, help='[Train Unlearn: 1e-5, Train USAI: 2e-5]')
    ...
    if args.set == "ViT_unlearn": 
        if args.R == 1 and args.resume :
            ...
            print("**********Build VITl32 Unlearning model**********")
    ...
    if args.set == "ViT_unlearn": 
        ...
        ### Compile model
        model.compile(loss=losses, optimizer=optimizers.RMSprop(learning_rate=opt), metrics=['accuracy'])
        ## Fit model 
