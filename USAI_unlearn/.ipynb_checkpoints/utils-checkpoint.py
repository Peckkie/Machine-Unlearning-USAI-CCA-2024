...
from ResNet152v2Model import build_baseResNet152v2, ResNetUnfreeze_conv3_block
from data_loader import Data_generator
from tensorflow.keras.models import load_model


def utils_createModel(network_name, sets, R, name, resume=False, checkpoint_dir=None, Modeljson_dir=None, imgsize=None):
    ## Create Model
    if network_name == "EffNetB5":
        if sets == "MLunlearn_USAI": 
            if resume :
                input_shape, model = loadresumemodel(checkpoint_dir)
            elif R == 1 and name == "unfreezeB4" :
            ...
            elif R == 1 and name == "unfreezeB4-B7" :
            ...
            elif R == 1 and name == "unfreezeB1-B4" :
            ...
            elif R == 1 and name == "unfreezeBlock5a_se_excite" :
    ...
    ## Create ResNet152V2 Model
        ...
        if sets == "MLorigin_USAI": 
            if R == 1 and name == "transfer" :
                ...
                print("---------- [INFO]: Load ResNet152V2 Base Model to Finetune Stage: unfreeze_conv3_block ----------")
                input_shape, model = ResNetUnfreeze_conv3_block(Modeljson_dir, checkpoint_dir)
